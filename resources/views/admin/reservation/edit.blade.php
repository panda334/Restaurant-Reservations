        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
           ...
           <div class="m-2 p-2">
            <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                <form method="POST" action="{{ route('adminreservation.update',$reservation->id) }}"  enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="sm:col-span-6">
                        <label for="name" class="block text-sm font-medium text-gray-700">First Name</label>
                        <div class="mt-1">
                            <input type="name" id="first_name"  name="first_name" value="{{ $reservation->first_name }}"
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <input type="name" id="last_name"  name="last_name" value="{{ $reservation->last_name }}"
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <input type="phone" id="phone_number"  name="phone_number" value="{{ $reservation->phone_number }}"
                            ...
                            <div   class="mt-1">
                                <select id="table_id" name="table_id" class="form-multiselect black w-full mt-1 @error('table_id') border-red-400 @enderror" multiple>
                                    @foreach ($tables as $table)
                                        <option value="{{ $table->id }}">@selected($table->id == $reservation->table_id) {{ $table->name }} [{{ $table->guest_number }}]{Guest Number}</option>
