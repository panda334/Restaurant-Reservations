    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
           <div class="flex justify-end m-2 p-2">
            <a href="{{ route('admintables.create') }}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">New Table</a>
           </div>
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="py-4 px-6  text-sm font-medium text-gray-800 whitespace-nowrap dark:text-white">
                   ...
                   <a href="{{ route('admintables.edit',$table->id) }}"
                     class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-lg text-white">Edit</a>
                   <form 
                   class="px-4 py-2 bg-red-500 hover-bg-red-700 rounded-lg text-white"
                   method="POST"
                   action="{{ route('admintables.destroy',$table->id) }}"
